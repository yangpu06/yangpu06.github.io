...
About Me
------
Hi,  I am a fourth-year Ph.D. student in the School of Computer Science at Beijing University of Posts and Telecommunications (BUPT), advised by <a href='https://teacher.bupt.edu.cn/wubin/zh_CN/index/41367/list/index.htm'>**Prof. Bin Wu (吴斌)**</a> and <a href='https://cs.bit.edu.cn/szdw/jsml/js/hlm/index.htm'>**Assoc. Prof. Linmei Hu (胡琳梅)**</a>. Before joining cSchool, I got my Master's degree in Computer Technology  at Chongqing University of Posts and Telecommunications (CQUPT), advised by <a href='https://www.idata.ah.cn/#/about/leaderDetail?id=2'>**Prof. Zuocheng Wang （王佐成）** </a> and <a href='https://faculty.cqupt.edu.cn/xiaoyp/zh_CN/index.htm'> **Prof. Yunpeng Xiao(肖云鹏)** </a>. My research interests lie in large-scale data mining and machine learning on various types of data (e.g., graph, text, and video), with a focus on developing AI/ML solutions for real-world problems.  During my Ph.D., I'm researching computer-psychology interdisciplinary field, specifically personality computing. This is my resume  [<a href='/files/CHICV.pdf' >**中文简历**</a>] [<a href='/files/ENGCV.pdf' >**CV**</a>].  <br>
